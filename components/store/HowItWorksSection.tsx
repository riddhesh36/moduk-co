      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {[
            ...
            { icon: CreditCard, title: "3. Add details & Pay", desc: "Enter your delivery details and pay securely." },
            { icon: MapPin, title: "4. Delivered Fresh", desc: "Hand-delivered fresh to your doorstep across Mumbai." },
          ].map((step, i) => (
            <motion.div 
              key={i}
